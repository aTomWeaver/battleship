...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"targetShip\": () => (/* binding */ targetShip)\n/* harmony export */ });\nfunction _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }\n\nfunction _nonIterableSpread() { throw new TypeError(\"Invalid attempt to spread non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.\"); }\n\nfunction _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === \"string\") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === \"Object\" && o.constructor) n = o.constructor.name; if (n === \"Map\" || n === \"Set\") return Array.from(o); if (n === \"Arguments\" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }\n\nfunction _iterableToArray(iter) { if (typeof Symbol !== \"undefined\" && iter[Symbol.iterator] != null || iter[\"@@iterator\"] != null) return Array.from(iter); }\n\nfunction _arrayWithoutHoles(arr) { if (Array.isArray(arr)) return _arrayLikeToArray(arr); }\n\nfunction _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, \"prototype\", { writable: false }); return Constructor; }\n\nfunction _classPrivateMethodInitSpec(obj, privateSet) { _checkPrivateRedeclaration(obj, privateSet); privateSet.add(obj); }\n\nfunction _checkPrivateRedeclaration(obj, privateCollection) { if (privateCollection.has(obj)) { throw new TypeError(\"Cannot initialize the same private elements twice on an object\"); } }\n\nfunction _classPrivateMethodGet(receiver, privateSet, fn) { if (!privateSet.has(receiver)) { throw new TypeError(\"attempted to get private field on non-instance\"); } return fn; }\n\nvar coinflip = function coinflip() {\n  return Math.floor(Math.random() * 2);\n};\n\nvar _isValidTarget = /*#__PURE__*/new WeakSet();\n\nvar _attackPerimeter = /*#__PURE__*/new WeakSet();\n\nvar targetShip = /*#__PURE__*/function () {\n  function targetShip(attackedSpaces) {\n    _classCallCheck(this, targetShip);\n\n    _classPrivateMethodInitSpec(this, _attackPerimeter);\n\n    _classPrivateMethodInitSpec(this, _isValidTarget);\n\n    for (var _len = arguments.length, hits = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {\n      hits[_key - 1] = arguments[_key];\n    }\n\n    this.spaces = [].concat(hits);\n    this.unavailableSpaces = _toConsumableArray(attackedSpaces);\n  }\n\n  _createClass(targetShip, [{\n    key: \"orientation\",\n    get: function get() {\n      console.log(this.spaces.length);\n      console.log(this.spaces);\n\n      if (this.spaces.length < 2) {\n        return \"none\";\n      } else if (Math.abs(this.spaces[1] - this.spaces[0]) == 1) {\n        return \"horizontal\";\n      } else {\n        return \"vertical\";\n      }\n    }\n  }, {\n    key: \"getTarget\",\n    value: function getTarget() {\n      var target;\n\n      if (this.orientation == 'none') {\n        target = _classPrivateMethodGet(this, _attackPerimeter, _attackPerimeter2).call(this, this.spaces[0]);\n      } else {\n        var lowestValHit = Math.min.apply(Math, _toConsumableArray(this.spaces));\n        var highestValHit = Math.max.apply(Math, _toConsumableArray(this.spaces));\n        console.log(lowestValHit, highestValHit);\n\n        if (this.orientation == \"vertical\") {\n          if (_classPrivateMethodGet(this, _isValidTarget, _isValidTarget2).call(this, highestValHit + 10)) {\n            target = highestValHit + 10;\n          } else if (_classPrivateMethodGet(this, _isValidTarget, _isValidTarget2).call(this, lowestValHit - 10)) {\n            target = lowestValHit - 10;\n          } else {\n            console.log('no valid move');\n          }\n        } else {\n          if (_classPrivateMethodGet(this, _isValidTarget, _isValidTarget2).call(this, highestValHit + 1)) {\n            target = highestValHit + 1;\n          } else if (_classPrivateMethodGet(this, _isValidTarget, _isValidTarget2).call(this, lowestValHit - 1)) {\n            target = lowestValHit - 1;\n          }\n        }\n      }\n\n      this.unavailableSpaces.push(target);\n      return target;\n    }\n  }]);\n\n  return targetShip;\n}();\n\nfunction _isValidTarget2(target) {\n  if (!this.unavailableSpaces.includes(target)) {\n    var center = this.spaces[0];\n\n    if (this.orientation == \"horizontal\" || target == center - 1 || target == center + 1) {\n      if (Math.floor(this.spaces[0] * 0.1) == Math.floor(target * 0.1)) {\n        return true;\n      } else {\n        return false;\n      }\n    } else if (this.orientation == \"vertical\" || target == center - 10 || target == center + 10) {\n      if (target > 0 && target < 100) {\n        return true;\n      } else {\n        return false;\n      }\n    }\n  } else {\n    return false;\n  }\n}\n\nfunction _attackPerimeter2(center) {\n  var _this = this;\n\n  var left = center - 1;\n  var up = center - 10;\n  var right = center + 1;\n  var down = center + 10;\n  var directions = [left, up, right, down];\n  return directions.find(function (dir) {\n    return _classPrivateMethodGet(_this, _isValidTarget, _isValidTarget2).call(_this, dir);\n  });\n}\n\n\n\n//# sourceURL=webpack://my-webpack-project/./src/cpuAI.js?");
